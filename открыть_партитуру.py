...
def open_musicxml_file(file_path):
    """Открывает файл MusicXML в программе по умолчанию"""
    try:
        ...
        print(f"Пожалуйста, откройте файл вручную: {os.path.abspath(file_path)}")
...
def main(image_path):
    ...
    print("\nпытаюсь открыть партитуру ...")
    open_musicxml_file(output_path)
